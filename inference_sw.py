...
print("="*80)
print("VITS MODEL PHONEMIZATION TEST")
print("="*80)

# 1. Load the configuration
print("\n[1/6] Loading configuration...")
config_path = "swahili_output/swahili_vits_2f_2m-October-28-2025_08+39PM-507c039d/config.json"
config = VitsConfig()
...
checkpoint_path = "swahili_output/swahili_vits_2f_2m-October-28-2025_08+39PM-507c039d/best_model.pth"
...
text = "Habari yako, wewe ni mzuri."
...
try:
    token_ids = model.tokenizer.text_to_ids(text, language="swa-Latn")
...
try:
    # Select a speaker
    speaker_name = "8694dcef-21e3-455b-b98f-c0baadf2b015"
    ...
    # Save the audio
    output_path = "test_phonemization_output.wav"
...
print("\n[BONUS] Testing with multiple sentences...")
print("-"*80)
...
for i, test_text in enumerate(test_sentences, 1):
    ...
    try:
        ...
        # Get token IDs
        tids = model.tokenizer.text_to_ids(test_text, language="swa-Latn")
        ...
        # Save
        save_path = f"test_sentence_{i}.wav"
